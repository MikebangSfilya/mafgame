...
- [x] ISS-20260527-001: [MVP Skeleton] Дневной цикл прототипа
	  - Evidence: тест трех дней, фаз, блокировки приказов и временных эффектов.
- [x] ISS-20260527-002: [MVP State] Карта, банды и бригады
	  - Evidence: 4 района, сетка 2x2, 3 банды, 2 бригады и стартовый CLI-вывод.
